...
Splat radius at the locked eye (distance \(4.2\), aperture \(1\), head mass \(1\)): \(\mathrm{mix}(0.018,0.072,0.5)\cdot 0.70 = 0.0315R\). Nested \(\Delta R\) must exceed that number or layers collapse the same way. Candidate \(0.08R\) is paper ([NEST.md](NEST.md)). Not packed. \(L=1\).
